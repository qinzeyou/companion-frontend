    ...
    <div class="content">
      ...
      <div v-show="showJoinTeamList" class="join-user-list">
        <van-space>
          ...
          <div
            class="join-team"
            @click="onJoinTeamBtn"
            v-if="team.maxNum != team.joinUserCount && !team.hasJoin"
          >
            +
          </div>
        </van-space>
      ...
      <div v-show="showOperationPanel" class="operation-panel">
        <van-button
          ...
          type="danger"
          size="mini"
          v-show="showDissolveBtn"
          @click="onDissolve(team.id)"
          >解散</van-button
        >
        <van-button plain type="warning" size="mini" @click="onLogout(team.id)"
          >退出</van-button
        >
