...
import CyTab from "@/pages/home/components/cy-tab.vue";
import useSystemStore from "@/stores/module/system-store";
...
const { noticeList } = toRefs(useSystemStore());
const { getNoticeData } = useSystemStore();
getNoticeData({ pageNum: 1, pageSize: 10 });
console.log();
</script>
...
<template>
  <div class="home-page">
    ...
    <div class="home-content">
      ...
      />
      <div
        v-show="!hasMoreData && recommendUserList.length >= 1"
        class="loading"
      >
        没有更多了
      </div>
